...
import { BackDrop, Wrap, Title, Cloud, Container } from './Home.styled';
...
const Home = (props) => {
  ...
  const { data, loading, error, setError, fetchWeather, setLoading } =
    useForecast();
    ...
    <>
      <Container>
        <BackDrop>
          ...
          <Cloud size="90" top="90" left="45" delay="3.5">
            <BsCloud />
          </Cloud>
